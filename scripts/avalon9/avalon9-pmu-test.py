...
PMU921_PG  = { 'pg_good': '0001', 'pg_bad': '0002' }

PMU921_LED = { 'led_close': '0000', 'led_green': '0001', 'led_red': '0002' }
...
PMU921_ADC = { 'ntc_l': 524, 'ntc_h': 9615, 'v12_l':2994, 'v12_h': 3810, 'vcore_l': 3230, 'vcore_h': 3427}
...
def detect_version():
    ...
    if res[14:16] == PMU921_VER:
        PMU_TYPE = PMU921_TYPE
        PMU_VER = res[14:29]
        PMU_ADC = PMU921_ADC
        PMU_LED = PMU921_LED
        PMU_PG  = PMU921_PG
